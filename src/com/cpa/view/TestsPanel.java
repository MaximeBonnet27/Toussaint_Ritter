...
public class TestsPanel extends JPanel {
  ...
  public TestsPanel() {
    l = new Line(new Point.Double(500, 120), new Point.Double(1, 1));
    l2 = new Line(new Point.Double(400,80), new Vector(1, 0.654));
    requestFocus();
  }
  ...
  private void drawLine(Line line, Graphics g, Color color) {
    ...
    drawPoint(new Point.Double(line.point.x + (int) line.director.x + 100, line.point.y + (int) line.director.y + 100 * (int) line.director.y), g2, Color.GREEN);
  }
